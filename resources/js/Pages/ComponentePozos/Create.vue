...
const state = reactive({
  ...
  comPozoFields: [
    { id: 0, name: 'dioxido_carbono' },
    { id: 1, name: 'pe_dioxido_carbono' },
    { id: 2, name: 'mo_dioxido_carbono' },
    { id: 3, name: 'den_dioxido_carbono' },
    { id: 4, name: 'acido_sulfidrico' },
    { id: 5, name: 'pe_acido_sulfidrico' },
    { id: 6, name: 'mo_acido_sulfidrico' },
    { id: 7, name: 'den_acido_sulfidrico' },
    { id: 8, name: 'nitrogeno' },
    { id: 9, name: 'pe_nitrogeno' },
    { id: 10, name: 'mo_nitrogeno' },
    { id: 11, name: 'den_nitrogeno' },
    { id: 12, name: 'metano' },
    { id: 13, name: 'pe_metano' },
    { id: 14, name: 'mo_metano' },
    { id: 15, name: 'den_metano' },
    { id: 16, name: 'etano' },
    { id: 17, name: 'pe_etano' },
    { id: 18, name: 'mo_etano' },
    { id: 19, name: 'den_etano' },
    { id: 20, name: 'propano' },
    { id: 21, name: 'pe_propano' },
    { id: 22, name: 'mo_propano' },
    { id: 23, name: 'den_propano' },
    { id: 24, name: 'iso_butano' },
    { id: 25, name: 'pe_iso_butano' },
    { id: 26, name: 'mo_iso_butano' },
    { id: 27, name: 'den_iso_butano' },
    { id: 28, name: 'n_butano' },
    { id: 29, name: 'pe_n_butano' },
    { id: 30, name: 'mo_n_butano' },
    { id: 31, name: 'den_n_butano' },
    { id: 32, name: 'iso_pentano' },
    { id: 33, name: 'pe_iso_pentano' },
    { id: 34, name: 'mo_iso_pentano' },
    { id: 35, name: 'den_iso_pentano' },
    { id: 36, name: 'n_pentano' },
    { id: 37, name: 'pe_n_pentano' },
    { id: 38, name: 'mo_n_pentano' },
    { id: 39, name: 'den_n_pentano' },
    { id: 40, name: 'n_exano' },
    { id: 41, name: 'pe_n_exano' },
    { id: 42, name: 'mo_n_exano' },
    { id: 43, name: 'den_n_exano' },
    { id: 44, name: 'no_determinacion' },
    { id: 45, name: 'equipo_utilizado' },
    { id: 46, name: 'met_laboratorio' },
    { id: 47, name: 'observaciones' },
    { id: 48, name: 'nombre_componente' },
  ],
})
